...
number = [int(almost_numbers) for almost_numbers in almost_numbers]
print(number)

# TODO: list comprehension to create a list of only the numbers that are
large_number = [number for number in number if number > 9]
print(large_number)
...
last_names = [name for name in full_names if len(name) > 11]
longer_surnames = [name.split()[-1] for name in last_names]
print(longer_surnames)
